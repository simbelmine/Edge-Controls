package com.example.sve.module;
...
public class Variables {
    ...
    public static final String MIDDLELEFTVISIBLE = "/middleleftvisible";
    public static final String MIDDLELEFTGONE = "/middleleftgone";
    public static final String DOWNLEFTVISIBLE = "/downleftvisible";
